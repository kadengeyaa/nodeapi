...
import { PermitDefaultMiddleware } from '../api/middleware/permission';
...
export function getContainer(): Container {
  ...
  container.bind<PermitDefaultMiddleware>(PermitDefaultMiddleware).to(PermitDefaultMiddleware);
